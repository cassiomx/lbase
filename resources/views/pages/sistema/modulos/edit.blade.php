...
@section('breadcrumbs')
    @include('breadcrumbs.sistema.modulos.edit')
@endsection
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                @endphp
                                {{ Form::select( 'tema', $temas, $result->tema, ['class' => $class, 'style'=>'width:100%'] ) }}
                                @if ($errors->has('tema'))
                                    <i class="form-group__feedback zmdi zmdi-close-circle"></i>
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                @endphp
                                {{ Form::select( 'cor', $cores, $result->cor, ['class' => $class, 'style'=>'width:100%'] ) }}
                                @if ($errors->has('cor'))
                                    <i class="form-group__feedback zmdi zmdi-close-circle"></i>
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                <label>Prefixo *</label>
                                <input type="text" name="prefixo" class="form-control {{ $errors->has('prefixo') ? ' is-invalid' : '' }}" placeholder="Prefixo" value="{{ $result->prefixo }}">
