...
@section('buttons')
    <div class="float-buttons">
        ...
        @include('elements.buttons.update', [ 'link' => route('sistema.perfil.update', $result->id) ] )
    </div>
@endsection
    ...
    <div class="col-lg-12">
        ...
        <div class="card">
            <div class="card-body">
                ...
                <form id="form-crud" method="post" action="{{ route('sistema.perfil.update', $result->id ) }}" >
                    @method('PATCH')
                    @csrf
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                <label>Login</label>
                                <input type="text" name="login" class="form-control" value="{{ $result->login }}" readonly>
                            </div>
                        </div>
                    </div>
                    <div class="row">
